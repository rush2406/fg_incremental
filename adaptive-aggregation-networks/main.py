...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='imagenet_sub', type=str, choices=['cifar100', 'imagenet_sub', 'imagenet'])
    parser.add_argument('--data_dir', default='/home/rushali.grandhe/CUB', type=str)
    ...
    parser.add_argument('--train_batch_size', default=96, type=int, help='the batch size for train loader')
    parser.add_argument('--test_batch_size', default=50, type=int, help='the batch size for test loader')
    ...
    parser.add_argument('--branch_mode', default='single', type=str, choices=['dual', 'single'], help='the branch mode for AANets')
    parser.add_argument('--branch_1', default='free', type=str, choices=['ss', 'fixed', 'free'], help='the network type for the first branch')
    ...
    parser.add_argument('--num_classes', default=200, type=int, help='the total number of classes')
    parser.add_argument('--nb_cl_fg', default=100, type=int, help='the number of classes in the 0-th phase')
    parser.add_argument('--nb_cl', default=10, type=int, help='the number of classes for each phase')
    parser.add_argument('--nb_protos', default=0, type=int, help='the number of exemplars for each class')
    ...
    parser.add_argument('--custom_weight_decay', default=5e-3, type=float, help='weight decay parameter for the optimizer')
    parser.add_argument('--custom_momentum', default=0.9, type=float, help='momentum parameter for the optimizer')
    parser.add_argument('--base_lr1', default=0.01, type=float, help='learning rate for the 0-th phase')
